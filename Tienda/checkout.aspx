<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="checkout.aspx.vb" Inherits="Tienda.checkout" %>
	...
	<header class="header">
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
				...
				<!-- Cart -->
				<div class="cart"><a href="cart.html"><div><img src="Scripts/littlecloset/images/cart.svg" alt="https://www.flaticon.com/authors/freepik"></div></a></div>
				<!-- Phone -->
					...
					<div class="col-lg-6 cart_col">
						<div class="cart_total">
							<div class="cart_extra_content cart_extra_total">
								...
								<div class="checkout_button trans_200"><a href="checkout.aspx">Realizar Pedido</a></div>
							</div>
						</div>
					</div>
				</div>
